...
--kullanmak istediğimiz componentta import ettim
--contextType yarıdımıyla contexti ilgili componenta atadık
...
//2-) Provider ---> Consumer
/* 
    1-) context içerisine bir tane class component oluşturduk ve verimizi state içerisine yerleştirdik.
    2-) Context'e ait Provider ile state te bulunan veriyi aldık 
    3-)parent child ilişkisi  {this.props.children} 
    4-) veriyi göndereceğimiz component'a context i import ediyoruz.
    5-)render içerisinde consumer ile provider dan gelen veriyi yakalıyoruz
*/
